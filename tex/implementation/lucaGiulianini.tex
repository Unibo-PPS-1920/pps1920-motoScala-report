...
\lstinputlisting[caption={ScreenLoader}, label=lst:listato3]{code/ScreenLoader.scala}
...
\lstinputlisting[caption={View e StateMachine}, label=lst:listato4]{code/View.scala}

\paragraph{Interazione View-Controller}
L'interazione tra \texttt{View} e \texttt{Controller} è stata implementata, come abbiamo già anticipato, sfruttando i pattern Observer basato su Eventi. Al fine limitare una possibile esplosione di eventi si è deciso di sfruttare una struttura ad \texttt{Algebraic Data Type} \textbf{gerarchica}.
...
\lstinputlisting[caption={Observer[Event]}, label=lst:listato5]{code/ObserverEvent.scala}
